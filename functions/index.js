...
exports.dialogflowFirebaseFulfillment = functions.https.onRequest((request, response) => {
    ...
    function categoria(agent) {
        ...
        db.ref('users/jacob/gastos/' + category).push({
            cantidad: num,
            fecha: day
        }, function (error) {
            if (error) {
...
let intentMap = new Map(); intentMap.set('Default Welcome Intent', welcome); intentMap.set('Default Fallback Intent', fallback); intentMap.set('Registro Gasto', categoria);
